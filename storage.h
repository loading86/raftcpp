...
public:
  ...
  virtual int32_t Entries(uint64_t lo, uint64_t hi, uint64_t maxSize,
...
public:
  ...
  int32_t CreateSnapshot(uint64_t index, raftpb::ConfState cs,
  ...
  int32_t Entries(uint64_t lo, uint64_t hi, uint64_t maxSize,
                  std::vector<raftpb::Entry> &entries);
