...
class Storage
{
    public:
        ...
        virtual int32_t Entries(uint64_t lo, uint64_t hi, uint64_t maxSize,std::vector<raftpb::Entry>& entries);
...
class MemoryStorage:public Storage
{
    ...
    public:
        ...
        int32_t Entries(uint64_t lo, uint64_t hi, uint64_t maxSize,std::vector<raftpb::Entry>& entries);
