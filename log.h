...
public:
  ...
  int32_t MaybeAppend(uint64_t index, uint64_t term, uint64_t commited,
  ...
  int32_t Entries(uint64_t index, uint64_t maxsize,
                  std::vector<raftpb::Entry> &entries);
  int32_t AllEntries(std::vector<raftpb::Entry> &entries);
  int32_t Slice(uint64_t lo, uint64_t hi, uint64_t max_size,
                std::vector<raftpb::Entry> &entries);
